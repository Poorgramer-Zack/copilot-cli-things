# Interactive Skill Patterns

Comprehensive guide to creating skills that gather user feedback and make decisions through the ask_user tool.

## Overview

Some skills need user input that doesn't work well with simple arguments. For example:
...
For these cases, use the **ask_user tool** within skill execution rather than relying on skill arguments.
...
## Skill Pattern for User Interaction

### Basic Interactive Skill

```markdown
---
description: Interactive setup skill
allowed-tools: ask_user, edit
---

# Interactive Plugin Setup

This skill will guide you through configuring the plugin with a series of questions.
...
Create `.github/plugin-name.local.md` with:
...
allowed-tools: ask_user, read, edit, execute
---

# Multi-Stage Deployment Setup

This skill walks through deployment setup in stages, adapting based on your answers.
...
allowed-tools: ask_user, execute
---
...
allowed-tools: ask_user, read, edit
---
...
## Best Practices for Interactive Skills
...
allowed-tools: ask_user, edit, read
---
...
Save to `.github/config-partial.yml`
...
allowed-tools: ask_user, execute, read
---
...
With ask_user, skills become interactive wizards that guide users through complex decisions while maintaining the clarity that simple arguments provide for straightforward inputs.
