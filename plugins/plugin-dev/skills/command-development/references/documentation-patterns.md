...
Strategies for creating self-documenting, maintainable skills with excellent user experience.

## Overview

Well-documented skills are easier to use, maintain, and distribute. Documentation should be embedded in the skill itself, making it immediately accessible to users and maintainers.

## Self-Documenting Skill Structure
...
```markdown
---
description: Complex multi-step skill
---
...
```markdown
---
description: Deployment skill with inline docs
---
...
```markdown
---
description: Interactive deployment skill
---
...
Create a help subcommand for complex skills:

```markdown
---
description: Main skill with help
...
[Skill continues if operation provided...]
```
...
```markdown
---
description: Skill with good error messages
---
...
[Skill continues if validation passes...]
```
...
```markdown
---
description: Skill with recovery guidance
---
...
```markdown
---
description: Skill with embedded examples
---

# Feature Skill

This skill performs feature analysis with multiple options.
...
Skills should have companion README files:
...
This skill is part of the [plugin-name] plugin.
...
Optional configuration file: `.github/command-name.local.md`
...
1. **In skill file**: Core usage, examples, inline explanations
...
2. **Active voice**: "Run the skill" not "The skill can be run"
...
With good documentation, skills become self-service, reducing support burden and improving user experience.
