...
**File:** `agents/docs-generator.agent.md`

```markdown
---
description: Use this agent when the user has written code needing documentation, API endpoints requiring docs, or explicitly requests documentation generation.
...
**File:** `agents/security-analyzer.agent.md`
...
- **Generator agents**: `[read, edit, grep]`
- **Executor agents**: `[read, edit, execute, grep]`
