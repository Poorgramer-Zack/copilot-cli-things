...
This is the exact system prompt used by Copilot CLI's agent generation feature, refined through extensive production use.
...
**agents/pr-quality-reviewer.agent.md:**
```markdown
---
description: Use this agent when the user asks to review a pull request, check code quality, or analyze PR changes.
---
...
2. Feed to Copilot with this system prompt
...
This provides AI-assisted agent generation following proven patterns from Copilot CLI's internal implementation.
