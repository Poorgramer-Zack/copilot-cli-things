...
Complete guide to authentication methods for MCP servers in Copilot CLI plugins.
...
Copilot CLI automatically handles the complete OAuth 2.0 flow for SSE and HTTP servers:

1. User attempts to use MCP tool
2. Copilot CLI detects authentication needed
3. Opens browser for OAuth consent
4. User authorizes in browser
5. Tokens stored securely by Copilot CLI
...
No additional auth configuration needed! Copilot CLI handles everything.
...
Tokens are stored securely by Copilot CLI:
