...
Basic skill patterns for common use cases.

**Important:** All examples below are written as instructions FOR Copilot (agent consumption), not messages TO users. Skills tell Copilot what to do, not tell users what will happen.

## Example 1: Code Review Skill

**File:** `.github/skills/review.md`
...
**File:** `.github/skills/security-review.md`
...
## Example 3: Test Skill with File Argument

**File:** `.github/skills/test-file.md`

```markdown
---
description: Run tests for specific file
argument-hint: [test-file]
allowed-tools: execute(npm:*), execute(jest:*)
---
...
**File:** `.github/skills/document.md`
...
**File:** `.github/skills/git-status.md`
...
## Example 6: Deployment Skill

**File:** `.github/skills/deploy.md`

```markdown
---
description: Deploy to specified environment
argument-hint: [environment] [version]
allowed-tools: execute(kubectl:*), read
---
...
## Example 7: Comparison Skill

**File:** `.github/skills/compare-files.md`
...
## Example 8: Quick Fix Skill

**File:** `.github/skills/quick-fix.md`
...
## Example 9: Research Skill

**File:** `.github/skills/research.md`
...
## Example 10: Explain Code Skill

**File:** `.github/skills/explain.md`
...
**Use for:** Simple, repetitive skills
...
## Tips for Writing Simple Skills
...
4. **Use descriptive names:** Skill name should indicate purpose
