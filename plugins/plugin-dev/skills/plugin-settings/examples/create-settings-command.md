...
allowed-tools: [edit, ask_user]
---

# Create Plugin Settings

This command helps users create a `.github/my-plugin.local.md` settings file.
...
Use edit tool to create `.github/my-plugin.local.md`:
...
To modify settings, edit this file and restart Copilot CLI.
```

### Step 4: Inform User

Tell the user:
- Settings file created at `.github/my-plugin.local.md`
- Current configuration summary
- How to edit manually if needed
- Reminder: Restart Copilot CLI for changes to take effect
