...
**.github/experimental-features.local.md:**
...
# Read settings
FRONTMATTER=$(sed -n '/^---$/,/^---$/{ /^---$/d; p; }' ".github/my-plugin.local.md")
...
Changes require Copilot CLI restart - hooks can't be hot-swapped.
