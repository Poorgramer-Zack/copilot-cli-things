...
Tests individual hook scripts with sample input before deploying to Copilot CLI.
...
**Features:**
- Sets up proper environment variables (PROJECT_DIR, PLUGIN_DIR)
...
- Path in hooks.json is correct (use relative paths like `./scripts/hook.sh`)
