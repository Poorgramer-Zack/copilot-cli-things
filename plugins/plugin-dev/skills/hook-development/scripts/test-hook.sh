...
EOF
    ...
    *)
      ...
      echo "Valid types: preToolUse, postToolUse, agentStop, subagentStop, userPromptSubmitted, sessionStart, sessionEnd"
      exit 1
      ;;
  esac
}
...
# Set up environment
export PROJECT_DIR="${PROJECT_DIR:-/tmp/test-project}"
export PLUGIN_DIR="${PLUGIN_DIR:-$(pwd)}"
export ENV_FILE="${ENV_FILE:-/tmp/test-env-$$}"
