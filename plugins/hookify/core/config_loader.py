...
Loads and parses .github/hookify.*.local.md files for Copilot CLI.
"""
...
def load_rules(event: Optional[str] = None) -> List[Rule]:
    """Load all hookify rules from .github directory.
    ...
    pattern = os.path.join('.github', 'hookify.*.local.md')
