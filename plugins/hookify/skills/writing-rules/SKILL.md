...
**Location:** All rules in `.github/` directory
**Naming:** `.github/hookify.{descriptive-name}.local.md`
**Gitignore:** Add `.github/*.local.md` to `.gitignore`
...
5. Create `.github/hookify.{name}.local.md` file in project root
