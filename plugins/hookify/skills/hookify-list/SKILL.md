...
**Status**: ✅ Active
**File**: .github/hookify.dangerous-rm.local.md
```
...
To create a rule: Use `hookify-create` skill
...
To get started:
1. Use `hookify-create` skill to analyze conversation and create rules
2. Or manually create `.github/hookify.my-rule.local.md` files
3. Use `hookify-help` skill for documentation

Example:
```
hookify-create Warn me when I use console.log
```
