...
A curated collection of extensions, skills, and plugins for [GitHub Copilot CLI](https://github.com/github/copilot-cli).
...
> # or type /experimental inside a running session (persists across launches)
> ```
